...
<section className="bg-center bg-no-repeat bg-[url('/hero-bg.png')] bg-gray-300 bg-blend-multiply">
    <div className=" flex flex-col justify-center items-center self-center text-center px-4 my-auto mx-auto max-w-screen-xl h-[60vh]">
        <h1 className="mb-4 text-2xl px-40 font-extrabold tracking-tight leading-none text-white md:text-4xl lg:text-5xl">Discover Digital Excellence: Your Gateway to Innovation</h1>
        <p className="mb-8 text-lg font-normal text-gray-100 lg:text-lg sm:px-16 lg:px-48">Millions of designers and agencies around the world showcase their portfolio work on ICOMM - the home to the world s best design and creative professionals.</p>
